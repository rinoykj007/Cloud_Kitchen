...
import { featuredMeal, popularMeals, recommendedMeals } from "../../data/mealData";

const MealExamples = () => {
  // Combine meals from different sources for a visual showcase
  const showcaseMeals = [
    ...popularMeals,
    featuredMeal,
          ...
          >
            <div className="relative h-48">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-3">
                <span className={`text-xs font-bold text-white px-2 py-1 rounded-full bg-${meal.categoryColor || "green"}-500`}>
                  {meal.category}
                </span>
              </div>
            </div>
              ...
              {meal.nutrition && (
                <div className="flex justify-between mt-2">
                  <div className="text-center">
                    ...
                    <div className="font-medium text-sm">{meal.nutrition.calories}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xs text-gray-500">Protein</div>
                    <div className="font-medium text-sm">{meal.nutrition.proteins}g</div>
                  </div>
                  <div className="text-center">
